class ApiConstants {
  ...
  static const String analyticsIncomeEndpoint = '/orders/analytics/income/{store_id}';
  static const String analyticsRevenueEndpoint = '/orders/analytics/revenue/{store_id}';
