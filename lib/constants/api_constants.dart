class ApiConstants {
  ...
  static const String uploadProductImagesEndpoint =
      '/products/{productId}/images';
  static const String getProductImagesEndpoint = '/products/{productId}/images';
  static const String deleteProductImageEndpoint =
  ...
  static const String chatConversationsEndpoint =
      '/chat/stores/{storeId}/conversations';
  static const String chatMessagesEndpoint =
      '/chat/conversations/{storeId}/messages';
  static const String sendMessageEndpoint = '/chat/messages';

  // Analytics Endpoints
  static const String analyticsEndpoint = '/analytics';
  static const String analyticsSummaryEndpoint =
      '/orders/analytics/summary/{storeId}';
  static const String analyticsDashboardEndpoint =
      '/orders/analytics/dashboard/{storeId}';
